...
from models.common import (C3, SPP, SPPF, Bottleneck, BottleneckCSP, C3x, Concat, Conv, CrossConv, DWConv,
                           DWConvTranspose2d, Focus, autopad, C3Ghost, GhostConv, GhostBottleneck)
...
class TFGhostBottleneck(keras.layers.Layer):
    ...
    def __init__(self, c1, c2, k=3, s=1, w=None):
        ...
        self.shortcut = (
            keras.Sequential(TFDWConv(c1, c1, k, s, act=False, w=sc1),
                             TFConv(c1, c2, 1, 1, act=False, w=sc1)) if s == 2 else tf.identity
        )
...
def parse_model(d, ch, model, imgsz):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [
            ...
            BottleneckCSP, C3, C3x, GhostConv, C3Ghost]:
            c1, c2 = ch[f], args[0]
