...
def export_tflite(
    ...
    if int8:
        ...
        dataset = LoadImages(data, img_size=imgsz, auto=False)
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "../datasets/images/test", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "best.pt", help="model.pt path(s)")
    parser.add_argument("--imgsz", "--img", "--img-size", nargs="+", type=int, default=[480, 480], help="image (h, w)")
